...
presentation:
	...
	##! компиляция презентации
presentation_eng: TARGET=presentation_eng
presentation_eng: SOURCE=presentation_eng
presentation_eng:
	$(compile)
...
clean:
	...
	"$(MAKE)" SOURCE=presentation_eng TARGET=presentation_eng clean-target
...
.PHONY: all dissertation synopsis presentation presentation_eng dissertation-draft \
